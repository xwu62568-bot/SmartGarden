...
export function InstallerShell() {
  ...
  return (
    <AppFrame
      header={isWorkbench || isProjectsView || isAlertsView || isCustomersView || isProfileView ? null : <TopBar title="安装商端" subtitle="项目、告警与客户的运营工作台" />}
      contentClassName={
        isWorkbench
      ...
      tabBar={<TabBar items={installerTabs} />}
    >
      <Outlet />
    </AppFrame>
  );
